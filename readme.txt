...
This program let you create a font for MUGEN game engine.
This program takes 3 command line arguments: graphic file, text file, font file.
...
2.0.6 - Small changes.
2.0.7 - 2.0.8 - Small bug was fixed.